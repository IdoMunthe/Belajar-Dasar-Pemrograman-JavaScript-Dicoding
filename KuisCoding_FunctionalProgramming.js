...
const highSalesBook = books.filter((book) => book.sales > 1000000);
const greatAuthors = highSalesBook.map((book)=> {return `${book.author} adalah penulis buku ${book.title} yang sangat hebat!`})
